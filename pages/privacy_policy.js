    ...
    <div className={style.page}>
      <div className="grid max-w-6xl place-self-center w-full h-full">
        <div className="flex flex-col mt-16 px-4">
          ...
          <div className="text-lg mt-4 mb-10 grid gap-2">
            <p>
              At Jann Kias, accessible from jannkias.com, one of our main
              priorities is the privacy of our visitors. This Privacy Policy
              document contains types of information that is collected and
              recorded by Jann Kias and how we use it.
            </p>
            ...
            <p>
              ...
              that they shared and/or collect in Jann Kias. This policy is not
            ...
            <h2 className="text-2xl font-semibold mt-4">Consent</h2>
            ...
            <p>
              Jann Kias follows a standard procedure of using log files. These
            ...
            <p>
              ...
              the advertising partners of Jann Kias.
            </p>

            <p>
              Third-party ad servers or ad networks uses technologies like
              cookies, JavaScript, or Web Beacons that are used in their
              respective advertisements and links that appear on Jann Kias,
            ...
            <p>
              Note that Jann Kias has no access to or control over these cookies
            ...
            <p>
              Jann Kias's Privacy Policy does not apply to other advertisers or
            ...
            <p>
              Jann Kias does not knowingly collect any Personal Identifiable
